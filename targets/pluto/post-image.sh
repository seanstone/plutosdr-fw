...
#$(O)/images/boot.frm:
cat ${O}/images/${TARGET}/boot.bin ${O}/images/uboot-env.bin ${BR2_EXTERNAL}/platform/target_mtd_info.key | tee ${O}/images/boot.frm | md5sum | cut -d ' ' -f1 | tee -a ${O}/images/boot.frm